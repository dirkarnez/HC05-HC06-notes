...
/*
If this code does not work, just try to relax the wiring connection
THIS WORKED
*/ 

SoftwareSerial btSerial(10, 11); // RX, TX
// D10 -> HC06's TX
// D11 -> voltage divider -> HC06's RX
void setup() {
  Serial.begin(9600);
  ...
  // delay(600);
  Serial.println("Uno initializing!");
  while (!btSerial.available()) {
    Serial.println("waiting for btSerial!");
  }
